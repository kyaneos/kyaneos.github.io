<svelte:head>
	<title>Projects - Justin Bonagura Moran</title>
</svelte:head>
...
<div class="container">
	...
	<section class="section">
		<p>
			Software projects focused on research tools, educational applications, and other miscellaneous projects.
			Most are open-source and available on GitHub.
		</p>
	</section>
	...
	<section class="section">
		...
		<div class="entry">
			<div class="entry-title">Transmission and Transformation of Social Reputations in Serial Reproduction</div>
			<div class="entry-subtitle">2025 • <a href="https://github.com/kyaneos/telephone" target="_blank" rel="noopener noreferrer">GitHub</a></div>
	...
	<section class="section">
		<h2>Previous Work</h2>
		<div class="entry">
			<div class="entry-title">Laboratory of Comparative Human Cognition Website</div>
			<div class="entry-subtitle">2023 - 2024 • <a href="https://lchcautobio.ucsd.edu/" target="_blank" rel="noopener noreferrer">Website</a></div>
			<div class="entry-description">
